...
import image from './bg-masthead.jpg'

function Action() {
    return<>
         <section className="call-to-action text-white text-center" id="signup" style={{backgroundImage:`url(${image})`, backgroundSize:"cover" , backgroundPosition:"center"}}>
                    ...
                    <div className="col-xl-6">
                        ...
                        <form className="form-subscribe" id="contactFormFooter" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div className="row">
                                ...
                                <div className="col-auto"><button className="btn btn-primary btn-lg enable" id="submitButton" type="submit">Submit</button></div>
                            </div>
